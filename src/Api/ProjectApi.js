const ProjectApi = [
    ...
    },
    {
        ...
        liveUrl: "",
        slides: [
            { url: "/assets/project media/CNMS/1.png", title: "CNMS1" },
            { url: "/assets/project media/CNMS/2.png", title: "CNMS2" },
            { url: "/assets/project media/CNMS/3.png", title: "CNMS3" },
            { url: "/assets/project media/CNMS/4.png", title: "CNMS4" },
            { url: "/assets/project media/CNMS/5.png", title: "CNMS5" },
            { url: "/assets/project media/CNMS/6.png", title: "CNMS6" },
            { url: "/assets/project media/CNMS/7.png", title: "CNMS7" },
            { url: "/assets/project media/CNMS/8.png", title: "CNMS8" },
            { url: "/assets/project media/CNMS/9.png", title: "CNMS9" },
            { url: "/assets/project media/CNMS/10.png", title: "CNMS10" },
            { url: "/assets/project media/CNMS/11.png", title: "CNMS11" },
            { url: "/assets/project media/CNMS/12.png", title: "CNMS12" },
        ],
        Type: "WebApp",
    ...
    },
    {
        ...
        liveUrl: "",
        slides: [
            { url: "/assets/project media/Open Code/1.png", title: "Open Code1" },
            { url: "/assets/project media/Open Code/2.png", title: "Open Code2" },
            { url: "/assets/project media/Open Code/3.png", title: "Open Code3" },
            { url: "/assets/project media/Open Code/4.png", title: "Open Code4" },
            { url: "/assets/project media/Open Code/5.png", title: "Open Code5" },
            { url: "/assets/project media/Open Code/6.png", title: "Open Code6" },
            { url: "/assets/project media/Open Code/7.png", title: "Open Code7" },
            { url: "/assets/project media/Open Code/8.png", title: "Open Code8" },
        ],
        Type: "WebApp",
    ...
    },
    {
        ...
        liveUrl: "",
        slides: [
            { url: "/assets/project media/RJ Hostel/rj1.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj2.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj3.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj4.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj5.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj6.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj7.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj8.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj9.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj10.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj11.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj12.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj13.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj14.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj15.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj16.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj17.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj18.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj19.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj20.png", title: "RJ Hostel" },
            { url: "/assets/project media/RJ Hostel/rj21.png", title: "RJ Hostel" },
        ],
        Type: "WebApp",
